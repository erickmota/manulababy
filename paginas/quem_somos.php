...
<head>
    ...
    <title>Quem Somos - Manulá Baby</title>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center mt-4">
            ...
            <div class="col-12 col-md-4 col-lg-3 text-center d-block d-md-none">

                <img class="shadow" id="imgApresentacao" src="img/fotoApresentacao.jpg" width="100%">

            </div>

            <div class="col-12 col-md-4 col-lg-3 text-center d-none d-md-block">
