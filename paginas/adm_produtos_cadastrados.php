...
<head>
    ...
    <title>Produtos Cadastrados - adm - Manulá Baby</title>
            ...
            <div class="col-12 col-md-9 offset-md-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col text-secondary">
                        ...
                        <img id="iconeMenu" style="cursor: pointer;" class="float-start mt-1 me-3 d-block d-md-none" src="img/menu.png" width="30px"><h1>Produtos Cadastrados</h1>
